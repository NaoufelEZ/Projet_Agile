...
<div class="content">
    ...
    <table border="1">
        ...
        <?php
        $sql = "SELECT * FROM products p , service s WHERE s.serviceID = p.idService;";
        $req = mysqli_query($conn,$sql);
        ...
        <td>". $ligne["pricePro"] ."</td>
        <td><div class='space'><a href='?accept=true&id=". $ligne["idProduct"] ."'><i class='fa-solid fa-pen-to-square'></i></a><a class='delete' href='?delete&id=". $ligne["idProduct"] ."'><i class='fa-solid fa-trash'></i></a></div></td>
        </tr>";
        $i++;
        }
        }
