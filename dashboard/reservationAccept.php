...
<div class="content">
    ...
    <table border="1">
        ...
        <?php
        $sql = "SELECT * FROM reservation r,service s,utilisateur u, products p WHERE s.serviceID = r.serviceID and  u.id_Utilisateur = r.clientID AND p.idProduct  = r.idProduct and status = 'Accept';";
        $req = mysqli_query($conn,$sql);
